% cd('/Users/alexth/test4/RSM/RSM_Utils/random/')
...
parameters.class = 'PL';
parameters.back_rgb = [1 1 1]*0.5;
parameters.map_file_name = '/Users/alexth/test4/RSM/RSM_Map_Vault/map_data034/map_data034.txt';

s_params = read_stim_lisp_output_hack('/Users/alexth/test4/RSM/RSM_Map_Vault/s36_test'); % read S file
...
% s_params = read_stim_lisp_output_hack('/Users/alexth/test4/RSM/RSM_Map_Vault/bars/s14'); % read S file
% 
% for i=2:size(s_params,2)
%     trial_params = combine_parameters(parameters, s_params{1}, s_params{i});
%     stimulus{i-1} = make_stimulus(trial_params, def_params);
...
s_params = read_stim_lisp_output_hack('/Users/alexth/test4/RSM/RSM_Map_Vault/gratings/s03'); % read S file
...
% parameters.map_file_name = '/Users/alexth/test4/RSM/RSM_Map_Vault/2011-12-13-2_f04_vorcones/map-0000.txt';
...
parameters.movie_name = '/Users/alexth/test4/RSM/RSM_Movie_Vault/test_5_A.rawMovie';
